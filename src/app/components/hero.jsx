    ...
    <div className="bg-image bg-white text-primary relative min-h-screen w-full">
      <div className="flex flex-col-reverse justify-center md:grid md:grid-cols-2 md:gap-16 container mx-auto min-h-screen">
        <div className="mx-4 flex flex-col justify-center z-40">
          ...
          <p className="text-sm sm:text-base my-2 sm:my-8 md:text-xl">
            Look no more, Ganesh Self Drive Rental Cars, has all variety of cars
            for you.
          </p>
          <Link href="/cars">
            <button className="text-xs md:text-sm btn btn-primary text-base-100 w-fit px-4 md:px-8">
              Explore Cars &#8594;
            </button>
          </Link>
        </div>
        <div className="md:flex justify-center items-center z-40 pt-16 sm:pt-24">
          <Image src="/car.png" alt="a white car" width={800} height={300} />
        </div>
      </div>
      <div className="hidden md:block absolute left-1/2 -translate-x-1/2 animate-bounce [animation-duration:1500ms] bottom-4">
